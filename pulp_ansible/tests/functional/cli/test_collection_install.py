...
def test_install_collection(
    tmp_path, install_scenario_distribution, pulp_admin_user, create_ansible_cfg
):
    ...
    with pulp_admin_user:
        ...
        create_ansible_cfg(temp_dir, install_scenario_distribution.client_url, pulp_admin_user)
...
def test_install_signed_collection(
    ...
    with user:
        ...
        create_ansible_cfg(temp_dir, install_scenario_distribution.client_url, user)
